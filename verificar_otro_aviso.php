        ...
        <div class="jumbotron">
            <div class="container">
                ...
                if ($id_mensaje != null &&
                    ...
                    $query = "INSERT INTO essbio.aviso VALUES ($id_mensaje,'$descripcion',NOW(),NOW(),$id_sumidero,$datosUsuario[0])";
                    $result = pg_query($query) or die('El registro fallo: ' . pg_last_error());

                    if ($result) {
                        echo"
                        <h1>En hora buena has mandado un Aviso</h1>
                        ...
                        <h1>A la proxima asegurate que hayans ingresado datos!</h1>
